...
class BoardGame:
    ...
    def __init__(self, layout, circle):
        ...
        # self.dice   = [ Die(type_die=DieType.SECURITY, moves=[1], probabilities=[1], probability_triggers=1.0),
        #                 Die(type_die=DieType.NORMAL, moves=[2], probabilities=[1], probability_triggers=1.0),
        #                 Die(type_die=DieType.RISKY, moves=[3], probabilities=[1], probability_triggers=1.0) ]
